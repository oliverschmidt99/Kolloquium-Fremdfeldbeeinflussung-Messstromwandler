...
% --- Folie 2: Kompensation ---
\begin{frame}{Lösungsansatz: Kompensierte Wandler}
    \begin{columns}[c]
        \begin{column}{0.55\textwidth}
            \textbf{Funktionsprinzip}
            \begin{itemize}
                \item Zusätzliche Wicklungen auf dem Eisenkern
                \item Erzeugung eines magnetischen Gegenfeldes
                \item Aktive Korrektur des Fehlers
            \end{itemize}
            \vspace{0.4cm}
            \textbf{Vor- und Nachteile}
            \begin{itemize}
                \item Deutliche Reduktion der Sättigung
                \item \textbf{Nachteil} Teuer \& mehr Platzbedarf
            \end{itemize}
        \end{column}
...
\subsection{Physikalische Hintergründe}
...
\subsection{Versuchsaufbau und Geometrie}

% --- Folie 6: Messstrecke (HERO IMAGE) ---
...
% --- Folie 7: Dreiecksanordnung (HERO IMAGE) ---
\begin{frame}{Konstruktive Maßnahme: Dreiecksanordnung}
    ...
    \includegraphics[height=0.75\textheight, width=0.95\textwidth, keepaspectratio]{03_Ressourcen/Bilder/kupferschinen_gesamtaufbau.pdf}
    ...
    \note{
        ...
        \textbf{Konstruktion:}
        Anstatt alle Schienen flach nebeneinander zu führen haben wir die mittlere Phase L2 räumlich um 140 Millimeter versetzt angeordnet.
