...
% --- Folie 7: Lastprofil (ehemals Verlauf Original) ---
\begin{frame}{Lastprofil und Prüfablauf}
    ...
    % Bild etwas kleiner, damit Text noch wirkt, aber immer noch dominant
...
% --- DIAGRAMM 0: Wahrer Fehler (Parallel vs. Dreieck) ---
\begin{frame}{Gesamtfehler im Vergleich: Parallel vs. Dreieck}
    \centering
    % Bild etwas skalieren, damit es gut passt
