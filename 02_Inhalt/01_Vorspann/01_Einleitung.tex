...
\begin{frame}{Problemstellung – Wirtschaftliche Relevanz}
    ...
    \begin{center}
        \begin{beamercolorbox}[wd=0.95\textwidth, sep=0.5em, center, rounded=true, shadow=true]{bluebox}
            ...
            \footnotesize \( P_{\text{Verlust}} = U_{\text{L-N}} \cdot \Delta I_{\text{L2}} \cdot \cos \varphi \cdot t \)
            \par\vspace{0.3em}
...
\begin{frame}{Zielsetzung der Arbeit}
    ...
    \begin{itemize}
        ...
        \item Prüfung konstruktiver Maßnahmen (Leitergeometrie / FFP)
    ...
    \note{
        ...
        \textbf{Vorgehen:}
        Dazu analysiere ich die Fehler im System systematisch vergleiche verschiedene Wandlertechnologien und prüfe geometrische Anpassungen.
