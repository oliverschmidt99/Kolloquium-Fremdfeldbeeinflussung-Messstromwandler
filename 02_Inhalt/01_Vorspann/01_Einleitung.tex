...
\begin{frame}{Zielsetzung der Arbeit}
    ...
    \begin{beamercolorbox}[wd=\linewidth, sep=0.6em, rounded=true, shadow=true]{goalbox}
    ...
    \vspace{1em} % Etwas mehr vertikaler Abstand zur Trennung

    % 3-Schritt-Logik als Kacheln
    % Breite auf 0.30 reduziert und \hfill eingefügt für mehr Zwischenraum
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.30\textwidth}
            \begin{beamercolorbox}[wd=\linewidth, sep=0.6em, center, rounded=true, shadow=true]{stepbox}
                \textbf{1 \,Analyse}\par
                \vspace{0.2em}
    ...
    \begin{beamercolorbox}[wd=\linewidth, sep=0.5em, rounded=true]{alerted text}
        \scriptsize \textbf{Bewertung:} Normkonformität \(\cdot\) Fremdfeldrobustheit \(\cdot\) Kosten \(\cdot\) Verfügbarkeit
    \end{beamercolorbox}
